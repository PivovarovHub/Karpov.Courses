...
# Настроим аргументы по умолчанию для дага 
default_args = {
...
def a_pivovarov_hw_3():
    ...
    #Создаем функцию, которая находит на какой платформе было больше всего игр, которые продались более чем миллионным тиражом в Северной Америке и возвращаем список
    @task()
