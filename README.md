...
2. Проанализировато результаты а\б теста промо акции. Определить лучшую метрику для анализа, сделать выводы.

3. Предложить ключевые метрики для оценки результатов промо.
